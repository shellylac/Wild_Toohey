...
homeModuleUI <- function(id) {
  ...
  div(
    ...
    div(
      ...
      tags$img(
        src = "wt-assets/wildtoohey_logo_ma_2.png",
        class = "wt-logo-img",
        alt = "Wild Toohey Logo"
      )
    ),
    ...
    card(
      ...
      card_body(
        div(
          h3(
            "Love wildlife? Love Toohey Forest?",
            br(),
            "Then you'll love Wild Toohey",
            class = "about-intro-text"
          ),
          p(
            "Wild Toohey harnesses public species occurrence data to help you get up close and personal to Toohey Forest's diverse wildlife inhabitants.",
            br(),
        ...
        card_body(
          tags$ol(
            tags$li(
              ...
              "in the Explorer tab by common name or taxonomy."
            ),
            tags$li(
              strong("View sightings:"),
              "in the Finder interactive map."
            ),
            tags$li(
              strong("Discover patterns:"),
              "explore past Trends and spatial Hotspots."
            ),
            tags$li(
              strong("View the Species List:"),
              "for species images and information."
            )
          )
        )
      )
    ...
    div(
      ...
      layout_column_wrap(
        ...
        card(
          ...
          card_body(
            p(
              "Use public sightings data to guide you to your own special wildlife encounter."
            )
          )
        ),
        card(
        ...
        card(
          ...
          card_body(
            p(
              "Check the species list for images, information, and observation counts."
            )
          )
        )
      )
